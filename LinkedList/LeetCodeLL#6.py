...
# In this context, a binary number is a sequence of 0s and 1s. The LinkedList class represents this 
# binary number such that each node in the linked list contains a single digit (0 or 1) of the binary number, 
# and the whole number is formed by traversing the linked list from the head to the end.
...
# To put it in simple terms, each digit of the binary number is multiplied by 2 raised to the power equivalent 
# to the position of the digit, counting from right to left starting from 0, and all the results are summed 
...
class LinkedList:
    ...
    def binary_to_decimal(self):
        # Storing our values in this variable
        num = 0
        ...
        while current is not None:
            ...
            # doing basic math to convert binary into decimal
