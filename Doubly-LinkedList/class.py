# Doubly Linked List
# They are LL but they have pointers pointing towards the previous node
...
class Node:
    def __init__(self, value):
        self.value = value
        self.next = None
        # main difference for DLL
        self.prev = None

# class containing functions to create and manipulate doublyLinkedList
class DoublyLinkedList:
    # Main constructor for the DLL class, exactly the same as LL
    def __init__(self, value):
        new_node = Node(value)
        self.head = new_node
        self.tail = new_node
    ...
    # prints the DLL, exactly the same as LL
    def print_list(self):
        temp = self.head
